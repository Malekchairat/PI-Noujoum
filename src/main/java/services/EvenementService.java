...
public class EvenementService implements IEvenementService {
    ...
    public void ajouter(Evenement e) throws SQLException {
        ...
        try (PreparedStatement st = this.cnx.prepareStatement(sql)) {
            ...
            ex.printStackTrace(); // Affiche le détail de l'erreur
        }
    }
    ...
    public Evenement recupererParId(int idEvenement) throws SQLException {
        ...
        try (PreparedStatement st = this.cnx.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                evenement.setArtist(rs.getString("artist"));
                evenement.setDescription(rs.getString("description"));
                evenement.setStartDate(new java.util.Date(rs.getDate("startDate").getTime()));
                evenement.setEndDate(new java.util.Date(rs.getDate("endDate").getTime()));
                evenement.setTime(rs.getInt("time"));
                evenement.setPrice(rs.getFloat("price"));
                evenement.setType(Type_e.valueOf(rs.getString("type")));
                evenement.setTicketCount(rs.getInt("ticketCount"));
            }
        } catch (SQLException ex) {
